 ...
 */
final class Version20220530194756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id NUMBER(10) NOT NULL, username VARCHAR2(180) NOT NULL, email VARCHAR2(180) NOT NULL, roles CLOB NOT NULL, password VARCHAR2(255) NOT NULL, is_verified NUMBER(1) NOT NULL, first_name VARCHAR2(30) NOT NULL, last_name VARCHAR2(30) NOT NULL, phone VARCHAR2(20) NOT NULL, PRIMARY KEY(id))');
